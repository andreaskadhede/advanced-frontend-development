    ...
    >
      ...
      <div className="card_middle">
        ...
        <div className=" card_filter_element">
          ...
          <div className="options">
            <button className="category">Populære</button>
            <button className="category">Skjulte perler</button>
          </div>
          <div className="options">
            <button className="category">Klassikere</button>
            <button className="category">Selskabsspil</button>
          </div>
          <div className="options">
            <button className="category">Quiz</button>
            <button className="category">Strategi</button>
          </div>
        </div>
      </div>
