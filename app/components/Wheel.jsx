...
export default function Wheel() {
  ...
  function resetWheel() {
    ...
    const wheel = document.getElementById("wheel");
    if (wheel) {
      wheel.style.transform = "rotate(11.25deg)"; // Reset the transform property
  ...
  return (
    <div className="container">
      ...
      <div
        onClick={spinWheel}
        disabled={isSpinning}
        className="boardgame button"
      >
        <div className="game_lid">
          <h2>{isSpinning ? "Spinning..." : "Tryk for at spinne!"}</h2>
        </div>
        <div className="game_box"></div>
      </div>

      <Button disabled fillColor="var(--blue)" text="" />
